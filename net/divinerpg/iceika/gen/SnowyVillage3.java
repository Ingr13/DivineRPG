...
import net.divinerpg.mob.entity.EntityWorkshopMerchant;
import net.divinerpg.mob.entity.EntityWorkshopTickerer;
...
public class SnowyVillage3 extends WorldGenerator
{
    ...
    public boolean generate(World world, Random rand, int i, int j, int k) {
        ...
        world.setBlock(i + 3, j + 1, k + 5, Block.doorIron.blockID);
        world.setBlock(i + 3, j + 1, k + 6, Block.doorIron.blockID);
        ...
        tinkerer.setLocationAndAngles(i + 3.0D, j + 1.0D, k + 3.0D, 0.0F, 0.0F);
        world.spawnEntityInWorld(tinkerer);

        EntityWorkshopMerchant merchant = new EntityWorkshopMerchant(world);
        merchant.setLocationAndAngles(i + 3.0D, j + 1.0D, k + 3.0D, 0.0F, 0.0F);
