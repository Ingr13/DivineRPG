...
public class WorldGenGiantTree extends WorldGenerator {
    ...
    private static WorldGenGiantTree world1;
    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
                ...
                for (int l4 = z - l1; l4 <= z + l1; l4++) {
                            ...
                            && (block == null || block.canBeReplacedByLeaves(world, i4, k3, l4)))
                    {
                        setBlockandMetadataIfChunkExists(world, i4, k3, l4,
                                IceikaBlockHelper.IceLeaves.blockID, 0);
        ...
        for (int l3 = 0; l3 < height - j3; l3++) {
            ...
            {
                setBlockAndMetadata(world, x, y + l3, z, IceikaBlockHelper.IceLog.blockID,
                        0);
                setBlockAndMetadata(world, x - 1, y + l3, z, IceikaBlockHelper.IceLog.blockID,
                        0);
                setBlockAndMetadata(world, x, y + l3, z - 1, IceikaBlockHelper.IceLog.blockID,
                        0);
                setBlockAndMetadata(world, x - 1, y + l3, z - 1, IceikaBlockHelper.IceLog.blockID,
                        0);
            }
        }
