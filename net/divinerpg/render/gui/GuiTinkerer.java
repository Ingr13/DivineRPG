...
import net.divinerpg.block.container.ContainerTinkerer;
...
public class GuiTinkerer extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3)
    {
        ...
        //this.mc.renderEngine.bindTexture("mods/DivineRPG/textures/gui/WorkshopWorker.png");
        mc.getTextureManager().bindTexture(ResourceGuiLoc.GUI_TINKERER);
