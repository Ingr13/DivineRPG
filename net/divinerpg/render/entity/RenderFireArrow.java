...
{
    private static final ResourceLocation field_110780_a = new ResourceLocation("DivineRPG:firearrow.png");
    ...
    protected ResourceLocation func_110779_a(EntityFireArrow par1EntityArrow)
    {
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		...
		return this.func_110779_a((EntityFireArrow)entity);
	}
}
