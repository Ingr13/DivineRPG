...
import net.divinerpg.mob.entity.EntityConstructor;
...
public class RenderConstructor extends RenderLivingCreature
{
    private float scale;
    public RenderConstructor(ModelBase model, float shadowSize, ResourceLocation textureLoc)
    {
