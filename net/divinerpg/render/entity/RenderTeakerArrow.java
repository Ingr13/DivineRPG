...
public class RenderTeakerArrow extends Render
{
    private static final ResourceLocation field_110780_a = new ResourceLocation("DivineRPG:teakerarrow.png");

    public void renderArrow(EntityVetheanArrow par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected ResourceLocation func_110779_a(EntityVetheanArrow par1EntityArrow)
    {
    ...
    {
        this.renderArrow((EntityVetheanArrow)par1Entity, par2, par4, par6, par8, par9);
    }

	@Override
	protected ResourceLocation getEntityTexture(Entity entity) {
		return this.func_110779_a((EntityVetheanArrow)entity);
	}
}
