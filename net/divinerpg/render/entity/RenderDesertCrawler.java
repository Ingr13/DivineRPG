...
import net.divinerpg.mob.entity.EntityDesertCrawler;
...
public class RenderDesertCrawler extends RenderLivingCreature
{
    public RenderDesertCrawler(ModelBase var1, float var2, ResourceLocation texture)
    {
