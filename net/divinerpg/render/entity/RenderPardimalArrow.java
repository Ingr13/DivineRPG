...
public class RenderPardimalArrow extends Render
{
    private static final ResourceLocation field_110780_a = new ResourceLocation("DivineRPG:pardimalarrow.png");

    public void renderArrow(EntityVetheanWarArrow par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected ResourceLocation func_110779_a(EntityVetheanWarArrow par1EntityArrow)
    {
    ...
    {
        this.renderArrow((EntityVetheanWarArrow)par1Entity, par2, par4, par6, par8, par9);
    }

	@Override
	protected ResourceLocation getEntityTexture(Entity entity) {
		// TODO Auto-generated method stub
		return this.func_110779_a((EntityVetheanWarArrow)entity);
	}
}
