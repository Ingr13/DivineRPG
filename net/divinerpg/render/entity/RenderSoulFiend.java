...
import net.divinerpg.mob.entity.EntitySoulFiend;
...
public class RenderSoulFiend extends RenderLivingCreature
{
    private float scale;

    public RenderSoulFiend(ModelBase var1, float var2, float var3, ResourceLocation textureLoc)
    {
