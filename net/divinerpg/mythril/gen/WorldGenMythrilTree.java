...
import net.divinerpg.uvite.gen.WorldGenEnergyTrees;
import net.minecraft.world.World;
import net.minecraft.world.biome.BiomeGenBase;
import net.minecraft.world.chunk.IChunkProvider;
import cpw.mods.fml.common.IWorldGenerator;

public class WorldGenMythrilTree implements IWorldGenerator
{
    @Override
    public void generate(Random var1, int var2, int var3, World var4, IChunkProvider var5, IChunkProvider var6)
    {
        switch (var4.provider.dimensionId)
        {
            ...
            case 5:
                this.generateMythril(var4, var1, var2 * 16, var3 * 16);

            default:
        }
    }

    public void generateMythril(World world, Random rand, int chunkX, int chunkZ) {
        BiomeGenBase biome = world.getWorldChunkManager().getBiomeGenAt(chunkX, chunkZ);
        WorldGenMythrilTrees tree = new WorldGenMythrilTrees(true);

        if((biome instanceof BiomeGenMythil))// then add ||BiomeGenXYZ if you want more.
        {
            for(int x = 0; x < 6; x++)
            {
    ...
    {
        BiomeGenBase biome = world.getWorldChunkManager().getBiomeGenAt(chunkX, chunkZ);
        WorldGenEnergyTrees tree = new WorldGenEnergyTrees();
