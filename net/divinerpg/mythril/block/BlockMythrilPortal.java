...
public class BlockMythrilPortal extends BreakableBase
{
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
        if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
        {
            ...
            else if (thePlayer.dimension != DimensionRegistry.MythrilID)
            {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, DimensionRegistry.MythrilID, new TeleporterMythril(thePlayer.mcServer.worldServerForDimension(DimensionRegistry.MythrilID)));
            }
            else {
                thePlayer.timeUntilPortal = 10;
