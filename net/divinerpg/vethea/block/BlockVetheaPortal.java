...
public class BlockVetheaPortal extends BreakableBase
{
    ...
    {
        super(par1, "Vethea", Material.portal, false);
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
        if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
        {
            ...
            else if (thePlayer.dimension != DimensionRegistry.VetheaID)
            {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, DimensionRegistry.VetheaID, new TeleporterVethea(thePlayer.mcServer.worldServerForDimension(DimensionRegistry.VetheaID)));
            }
            else {
                thePlayer.timeUntilPortal = 10;
    ...
    {
        //TODO: Vethea blocked until worldgen crash is resolved.
