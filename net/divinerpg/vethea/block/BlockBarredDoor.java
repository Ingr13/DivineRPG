...
{
	private static final String[] doorIconNames = new String[] {Reference.MOD_ID + ":" + "BarredDoor_Bottom", Reference.MOD_ID + ":" + "BarredDoor_Top"};
	 ...
	 public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
	 ...
	 {
		 return (par1 & 8) != 0 ? 0 : VetheaItemHelper.BarredDoor.itemID;
	 }
	 ...
	 {
		 return VetheaItemHelper.BarredDoor.itemID;
	 }
