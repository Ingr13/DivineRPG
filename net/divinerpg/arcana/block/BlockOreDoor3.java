...
{
    private static final String[] doorIconNames = new String[] {"DivineRPG:SoulStone", "DivineRPG:OreDoor3"};
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        if (this.blockMaterial == Material.wood)
        {
            ...
            {
                if (itemstack.itemID == ArcanaItemHelper.key1.itemID)
                {
    ...
    {
        return ArcanaItemHelper.OreDoor3.itemID;
    }
