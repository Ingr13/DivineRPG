...
public class ItemConfigHelper {
	...
	public static void initConfig(FMLPreInitializationEvent event) {
		...
		hordeHornID = config.getItem("", 3445).getInt();
		mysteriousClockID = config.getItem("", 3446).getInt();
		watchingEyeID = config.getItem("", 3447).getInt();
		callOfTheWatcherID = config.getItem("", 3448).getInt();
		furyFireID = config.getItem("", 3449).getInt();
