...
public class TwilightRecipeHelper {
    ...
    public static void initItems() {
        ...
        // GameRegistry.addRecipe(new ItemStack(TwilightItemHelper.spawnMamormeter, 1), new Object[] {"xxx", "xyx", "xxx", 'x', TwilightItemHelper.purpleBlaze, 'y', TwilightItemHelper.infernoSword});
       ...
       // GameRegistry.addRecipe(new ItemStack(TwilightBlockHelper.DraviteLamp, 1), new Object[] { "xxx", "xyx", "xxx", 'y', TwilightItemHelper.draviteFragment, 'x', Item.ingotIron });
    }
