...
public class OverworldRecipeHelper {
    ...
    public static void initSmelting() {
        ...
        GameRegistry.addSmelting(Block.pumpkin.blockID, new ItemStack(Item.pumpkinPie, 1), 0);
    ...
    public static void initItems() {
        ...
        GameRegistry.addRecipe(new ItemStack(OverworldItemHelper.callOfTheWatcher, 1), new Object[] {" x ", "zyz", " z ", 'y', OverworldItemHelper.watchingEye, 'x', OverworldItemHelper.hellStoneIngot, 'z', OverworldItemHelper.moltenStone});
    ...
    public static void initWeapons() {
        ...
        GameRegistry.addRecipe(new ItemStack(OverworldItemHelper.massivence, 1), new Object[] {"x x", "yyy", " y ", 'x', OverworldItemHelper.glowingGem, 'y', OverworldItemHelper.netheriteIngot});
