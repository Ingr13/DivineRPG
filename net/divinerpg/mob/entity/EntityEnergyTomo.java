...
public class EntityEnergyTomo extends EntityMob
{
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setAttribute(31); // Attack
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setAttribute(700); // MaxHP
    }
